/**
  ...
  * Version: V1.2.9
  * Date   :
  * Brief  : using interrupt mode for USART TX/RX and FIFO for accessing by multiple serial port simultaneously 
  *********************************************************************************************************
  */
...
/**
 * @brief   Initialize all hardware included on the AT-STRAT-F413 board
 * @param   None
 * @retval  None
 */
