/*
 * Note: A Round Robin scheduling algorithm does not guarantee time is shared
 * equally between tasks of equal priority, only that Ready state tasks
 * of equal priority will enter the Running state in turn.
 */
