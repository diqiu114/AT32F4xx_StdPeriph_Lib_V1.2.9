 ...
 * (1)Counting events. They are created with an initial
 *    count value of zero.
 * (2)Resource management. They are created with an initial
 *    count value equals the number of resources that are
 *    available.
 *
 */
