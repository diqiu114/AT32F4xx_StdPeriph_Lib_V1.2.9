 ...
 * exclusion without the risk of priority inversion or deadlock
 ...
 * any other task needing to access the resource can do so only indirectly
 * by using the services of the gatekeeper
 */
