 ...
 * synchronizing the task with the interrupt. This allows the majority
 * of the interrupt event processing to be implemented within the 
 * synchronized task, with only a very fast and short portion remaining
 * directly in the ISR.
 *
 */
...
static void AppTaskCreate (void)
{
    ...
    xReturn = xTaskCreate(  vTaskLED,   	    // function of task
                            ...
                            256,               	// stack size. specify the number of words(32bits) */
                            NULL,              	// task parameter*/
